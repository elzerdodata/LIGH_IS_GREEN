...
// v0.8.5 keeps the picture settings panel and refines the full
...
inline constexpr QuickRect kSessionGuideRect{1552, 210, 232, 48};
inline constexpr QuickRect kSessionSteamRect{1552, 266, 232, 48};
inline constexpr QuickRect kSessionAltTabRect{1552, 322, 232, 48};
inline constexpr QuickRect kSessionKeyboardRect{1552, 378, 232, 48};
inline constexpr QuickRect kSessionMouseRect{1552, 434, 232, 48};
inline constexpr QuickRect kSessionReconnectRect{1552, 490, 232, 48};
inline constexpr QuickRect kSessionSettingsRect{1552, 546, 232, 48};
inline constexpr QuickRect kSessionCloseRect{1552, 602, 232, 48};
...
struct QuickMenuState {
    ...
    // Local-only virtual pointer state. The coordinates match the normalized
    // mouse coordinates sent to Boosteroid. The renderer draws this cursor on
    // top of the stream and hides it after a short inactivity timeout.
    float mouseCursorX = 0.5f;
    float mouseCursorY = 0.5f;
...
inline QuickMenuState normalized_quick_menu(QuickMenuState state) {
    ...
    state.mouseCursorX = std::clamp(state.mouseCursorX, 0.0f, 1.0f);
    state.mouseCursorY = std::clamp(state.mouseCursorY, 0.0f, 1.0f);
    return state;
}
